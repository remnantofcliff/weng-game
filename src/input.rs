...
impl Input {
    ...
    pub fn change_texture(&self) -> bool {
        self.commands.contains(Commands::CHANGE_TEXTURE)
    }
    ...
    pub fn update(&mut self, window: &Window) {
        ...
        let move_x = window.key_down(glfw::Key::A) as i8 - window.key_down(glfw::Key::D) as i8;
        ...
        self.commands = [
            (glfw::Key::F2, Commands::CHANGE_TEXTURE),
